...
#------------------------------------------Write data start-------------------------------------#
write.csv(centrality,"Centrality_Email-Enron.csv")
write.csv(ncentrality,"NCentrality_Email-Enron.csv")
