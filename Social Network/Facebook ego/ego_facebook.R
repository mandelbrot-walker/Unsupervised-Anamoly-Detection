...
boxplot(ndegree, neigenvector, ncloseness, npagerank,nbetweenness,nhubscore,nauthorities,
        main = "Multiple boxplots for comparision",
        at = c(1,2,3,4,5,6,7),
        names = c("ndegree", "neigenvector", "ncloseness", "npagerank","nbetweenness","nhubscore","nauthorities"),
        las = 2,
        col = c("orange","red"),
        border = "brown",
        horizontal = TRUE,
        notch = FALSE
) #multiple boxplot #without ncrossclique #names = c("ndegree", "neigenvector", "ncloseness", "npagerank","ncrossclique","nbetweenness","nhubscore","nauthorities"),
#------------------------------------------Boxplot end-------------------------------------#
...
ncen_tr<-data.frame(names = c('degree','eigenvector','closeness','pagerank','betweeness','hubscore','authorities'),ncen_tr) #y label
...
#tsne model 4
set.seed(32)  
tsne_model_4 = Rtsne(ncentrality2, check_duplicates=FALSE, pca=TRUE, perplexity=50, theta=0.20, dims=2, max_iter = 2000,
                     verbose = TRUE, is_distance = FALSE, pca_center = TRUE, pca_scale = TRUE, num_threads = 7)
plot(tsne_model_4$Y,col=ncen_tr$names, asp=1)

#tsne model 5
set.seed(323)  
tsne_model_5 = Rtsne(ncentrality2, check_duplicates=FALSE, pca=TRUE, perplexity=100, theta=0.10, dims=2, max_iter = 1500,
...
#tsne model 7
set.seed(358)  
tsne_model_7 = Rtsne(ncentrality2, check_duplicates=FALSE, pca=TRUE, perplexity=43, theta=0.10, dims=2, max_iter = 5000,
                     verbose = TRUE, is_distance = FALSE, pca_center = TRUE, pca_scale = TRUE, num_threads = 7)
