...
round(calinhara(m1,ck2$cluster),digits=2) #  893.34  
round(calinhara(m1,ck3$cluster),digits=3) #  2290.924  Highest  
round(calinhara(m1,ck4$cluster),digits=4) #  2285.727  
round(calinhara(m1,ck5$cluster),digits=5) #  2030.947  
round(calinhara(m1,ck6$cluster),digits=6) #  1813.201
round(calinhara(m1,ck7$cluster),digits=7) #  1835.995
round(calinhara(m1,ck8$cluster),digits=8) #  1682.526
...
#  Checking for correct no of clusters. Higher the index value better the cluster
round(calinhara(m2,ck2$cluster),digits=2) #  910.22 
round(calinhara(m2,ck3$cluster),digits=3) #  2320.783  Highest  
round(calinhara(m2,ck4$cluster),digits=4) #  2232.352
round(calinhara(m2,ck5$cluster),digits=5) #  2035.78  
round(calinhara(m2,ck6$cluster),digits=6) #  1816.875
round(calinhara(m2,ck7$cluster),digits=7) #  1853.98
round(calinhara(m2,ck8$cluster),digits=8) #  1697.613
...
#  Checking for correct no of clusters. Higher the index value better the cluster
round(calinhara(m3,ck2$cluster),digits=2) #  7097.18  Highest
round(calinhara(m3,ck3$cluster),digits=3) #  4033.393  
round(calinhara(m3,ck4$cluster),digits=4) #  2775.979    
round(calinhara(m3,ck5$cluster),digits=5) #  2131.534  
round(calinhara(m3,ck6$cluster),digits=6) #  1810.79
round(calinhara(m3,ck7$cluster),digits=7) #  1514.534
round(calinhara(m3,ck8$cluster),digits=8) #  1393.337
round(calinhara(m3,ck9$cluster),digits=9) #  1161.763
round(calinhara(m3,ck10$cluster),digits=10) #  1087.637
...
#  Checking for correct no of clusters. Higher the index value better the cluster
round(calinhara(m4,ck2$cluster),digits=2) #  1399.62    
round(calinhara(m4,ck3$cluster),digits=3) #  1822.306  Highest
round(calinhara(m4,ck4$cluster),digits=4) #  1530.507    
round(calinhara(m4,ck5$cluster),digits=5) #  1465.714
round(calinhara(m4,ck6$cluster),digits=6) #  1272.972
round(calinhara(m4,ck7$cluster),digits=7) #  1085.338
round(calinhara(m4,ck8$cluster),digits=8) #  966.9558
round(calinhara(m4,ck9$cluster),digits=9) #  909.4277
...
#  Checking for correct no of clusters. Higher the index value better the cluster
round(calinhara(m5,ck2$cluster),digits=2) #  1298  
round(calinhara(m5,ck3$cluster),digits=3) #  2017.838  Highest  
round(calinhara(m5,ck4$cluster),digits=4) #  1878.96
round(calinhara(m5,ck5$cluster),digits=5) #  1685.858  
round(calinhara(m5,ck6$cluster),digits=6) #  1590.251
round(calinhara(m5,ck7$cluster),digits=7) #  1731.895
round(calinhara(m5,ck8$cluster),digits=8) #  1627.486
...
#  Checking for correct no of clusters. Higher the index value better the cluster
round(calinhara(m6,ck2$cluster),digits=2) #  2409.68    
round(calinhara(m6,ck3$cluster),digits=3) #  3214.101  Highest
round(calinhara(m6,ck4$cluster),digits=4) #  2662.363  
round(calinhara(m6,ck5$cluster),digits=5) #  2266.744
round(calinhara(m6,ck6$cluster),digits=6) #  890.2575 
round(calinhara(m6,ck7$cluster),digits=7) #  759.6421
round(calinhara(m6,ck8$cluster),digits=8) #  665.3671
...
#  Checking for correct no of clusters. Higher the index value better the cluster
round(calinhara(m7,ck2$cluster),digits=2) #  294.09  
round(calinhara(m7,ck3$cluster),digits=3) #  1323.454  Highest    
round(calinhara(m7,ck4$cluster),digits=4) #  1010.218    
round(calinhara(m7,ck5$cluster),digits=5) #  783.4589
round(calinhara(m7,ck6$cluster),digits=6) #  660.5547
...
#  Checking for correct no of clusters. Higher the index value better the cluster
round(calinhara(m8,ck2$cluster),digits=2) #  54.66  
round(calinhara(m8,ck3$cluster),digits=3) #  913.892
round(calinhara(m8,ck4$cluster),digits=4) #  2171.739  Highest
round(calinhara(m8,ck5$cluster),digits=5) #  1940.96
round(calinhara(m8,ck6$cluster),digits=6) #  1713.143
...
#  Checking for correct no of clusters. Higher the index value better the cluster
round(calinhara(m9,ck2$cluster),digits=2) #  1769.28  Highest   
round(calinhara(m9,ck3$cluster),digits=3) #  1219.287
round(calinhara(m9,ck4$cluster),digits=4) #  963.3785
round(calinhara(m9,ck5$cluster),digits=5) #  824.8776
round(calinhara(m9,ck6$cluster),digits=6) #  702.578
...
gc()
ckm3<-Skmeans(data=as.matrix(m3),centers=2,iter.max = 25,nthread = 5,init = c("kmeanspp"),tolerance = 0.0005)
gc()
ckm4<-Skmeans(data=as.matrix(m4),centers=3,iter.max = 25,nthread = 5,init = c("kmeanspp"),tolerance = 0.0005)
gc()
ckm5<-Skmeans(data=as.matrix(m5),centers=3,iter.max = 25,nthread = 5,init = c("kmeanspp"),tolerance = 0.0005)
gc()
ckm6<-Skmeans(data=as.matrix(m6),centers=3,iter.max = 25,nthread = 5,init = c("kmeanspp"),tolerance = 0.0005)
gc()
ckm7<-Skmeans(data=as.matrix(m7),centers=3,iter.max = 25,nthread = 5,init = c("kmeanspp"),tolerance = 0.0005)
gc()
